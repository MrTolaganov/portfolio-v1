  ...
  return (
    <div className='flex justify-between md:flex-col flex-row md:text-xl w-full gap-2 max-md:h-10'>
      <Link
        ...
        target='_blank'
        className=' bg-card rounded-2xl px-4 flex items-center gap-2 flex-1 max-md:justify-center'
      >
        <FaTelegramPlane />
      ...
      <span className=' bg-card rounded-2xl px-4 flex items-center gap-2 flex-1 max-md:justify-center '>
        <SiGmail />
        <span className='max-md:hidden'>tulaganovok04@gmail.com</span>
      </span>

      <div className=' bg-card rounded-2xl px-4 flex items-center gap-2 flex-1 max-md:justify-center'>
        <FaPhoneAlt />
